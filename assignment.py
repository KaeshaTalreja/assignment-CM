...
def snapshot():
    ...
    messagebox.showinfo("Saved!!", "Slam saved as screenshot..")
...
main_window.configure(bg=colorBG,padx=90)
...
txtName = Entry(main_window, bd =1,fg=txtBG,bg=colorBG,font=box)
...
txtNickname = Entry(main_window, bd =1,fg=txtBG,bg=colorBG,font=box)
...
txtPronoun = Entry(main_window, bd =1,fg=txtBG,bg=colorBG,font=box)
...
txtFood = Entry(main_window, bd =1,fg=txtBG,bg=colorBG,font=box)
...
txtColorSmell = Entry(main_window, bd =1,fg=txtBG,bg=colorBG,font=box)
...
txtAboutYourself = Text(main_window, fg=txtBG,bg=colorBG,font=box,borderwidth=0,height=3,width=50)
...
txtBucks = Text(main_window,fg=txtBG,bg=colorBG,font=box,height=3,width=50)
...
txtSoulmate = Text(main_window, bd =1,fg=txtBG,bg=colorBG,font=box,height=3,width=50)
...
txtAdvice = Text(main_window, bd =1,fg=txtBG,bg=colorBG,font=box,height=3,width=50)
...
txtLockdown = Text(main_window, bd =1,fg=txtBG,bg=colorBG,font=box,height=3,width=50)
...
btnSubmit=Button(main_window,text="Send",bg=colorBG,fg='black',bd=0,font=cursive,relief='raised',command=snapshot)
btnSubmit.grid(row=14,column=5,sticky='W')

btnExit = Button(main_window, text="Exit", command=main_window.destroy,bg=colorBG,fg='black',bd=0,font=cursive,relief='raised')
btnExit.grid(row=14,column=6,sticky='W')
